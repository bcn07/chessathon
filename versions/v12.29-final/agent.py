...
# 21 = the 30 s budget minus 7 s safety minus ~2 s of process age at import
INIT_COMPILE_WAIT_S = float(os.environ.get("CHESSATHON_INIT_COMPILE_WAIT", "21"))
...
INIT_SAFETY_S = 7.0  # covers the ready line, handshake and a slow host; 10 was sized for 90 s
